...
correrTests = hspec $ do
  ...
  describe "Test del ejercicio 3  - Los sueños se cumplen" $ do
    ...
    it "Test con una persona que viajó" $ do
      ((felicidonios).viaja ["Madrid","Roma"]) Persona{
        nombre="",
        edad=0,
        felicidonios=0,
        habilidades=[],
      ...
      ((edad).viaja["Verona","Como","Milan"]) Persona{
        nombre="",
        edad=0,
        felicidonios=0,
        habilidades=[],
    ...
    it "Test de una persona conformista" $ do
      (nombre.queTodoSigaIgual) Persona{
        nombre="",
        edad=0,
        felicidonios=0,
        habilidades=[],
      ...
      (felicidonios.queTodoSigaIgual) Persona{
        nombre="",
        edad=0,
        felicidonios=0,
        habilidades=[],
      ...
      (habilidades.queTodoSigaIgual) Persona{
        nombre="",
        edad=0,
        felicidonios=0,
        habilidades=[],
      ...
      (length.suenios.queTodoSigaIgual) Persona{
        nombre="",
        edad=0,
        felicidonios=0,
        habilidades=[],
    ...
    it "Test con alguien que cumplió el combo perfecto" $ do 
      (felicidonios.comboPerfecto) Persona{
        nombre="",
        edad=0,
        felicidonios=0,
        habilidades=[],
      ...
      (habilidades.comboPerfecto) Persona{
        nombre="",
        edad=0,
        felicidonios=0,
        habilidades=[],
